...
public class SeleniumWebDriverUploadFilePageObject {
	...
	private static String browserPage= "/src/main/resources/com/selenium/webpages/SeleniumWebdriverUploadFile.html"; //file path relative to project workspace in Jenkins
